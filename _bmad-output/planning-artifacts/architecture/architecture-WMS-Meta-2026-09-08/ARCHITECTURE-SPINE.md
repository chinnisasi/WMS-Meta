...
- **True `numeric` quantities** — considered at the AD-9 amendment (2026-09-17) and rejected for scaled integers, because decimals cannot cross the Valkey/Lua reservation path safely. Revisit only if a UoM ever needs more than 6 decimal places.
